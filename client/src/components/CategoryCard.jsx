/**
 * ============================================================================
 * MODULE: Category Card (Bento Grid Item)
...
// Icon mapping for categories — using simple SVG icons
const icons = {
    'share-2': (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 103.935 0m-3.935 0a2.25 2.25 0 00-3.935 0m7.87-12.014a2.25 2.25 0 103.935 0 2.25 2.25 0 00-3.935 0" />
        </svg>
    ),
    'users': (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export default function CategoryCard({ category, index }) {
    const icon = icons[category.icon] || icons['layout-grid'];
